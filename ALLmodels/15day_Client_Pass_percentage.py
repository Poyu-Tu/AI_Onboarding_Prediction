# Best model for target 11: RandomForestRegressor(max_depth=20, min_samples_leaf=2, min_samples_split=5) with R² score: 0.2539200406004216
import pandas as pd
import numpy as np
import pickle
...
# 選擇特徵針對目標變量
target_index = 11  # '15day_客戶面試通過_percentage' 在 y 的第 12 列
...
# 保存最佳模型
model_filename = f'15day_客戶面試通過_percentage_{target_index}.pkl'
