# Best model for target 16: GradientBoostingRegressor(learning_rate=0.01, max_depth=9, subsample=0.6) with R² score: 0.04851535877763957
import pandas as pd
import numpy as np
import pickle
...
# 選擇特徵針對目標變量
target_index = 16  # '30day_正式入職_percentage' 在 y 的第 17 列
...
# 保存最佳模型
model_filename = f'30day_正式入職_percentage_{target_index}.pkl'
