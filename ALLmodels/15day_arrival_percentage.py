# Best model for target 17: <catboost.core.CatBoostRegressor object at 0x000001E357538D10> with R² score: 0.0030216506897042805
import pandas as pd
import numpy as np
import pickle
...
# 選擇特徵針對目標變量
target_index = 17  # '15day_正式入職_percentage' 在 y 的第 18 列
...
# 保存最佳模型
model_filename = f'15day_正式入職_percentage_{target_index}.pkl'
