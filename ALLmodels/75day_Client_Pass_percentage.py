# Best model for target 7: GradientBoostingRegressor(learning_rate=0.01, max_depth=9, subsample=0.8) with R² score: 0.30138291290948005
import pandas as pd
import numpy as np
import pickle
...
# 選擇特徵針對目標變量
target_index = 7  # '75day_客戶面試通過_percentage' 在 y 的第 8 列
...
# 保存最佳模型
model_filename = f'75day_客戶面試通過_percentage_{target_index}.pkl'
