# Best model for target 3: RandomForestRegressor(min_samples_leaf=4, min_samples_split=10,n_estimators=200) with R² score: 0.10767285091469181
import pandas as pd
import numpy as np
import pickle
...
# 選擇特徵針對目標變量
target_index = 3  # '45day_WITS面試通過_percentage' 在 y 的第 4 列
...
# 保存最佳模型
model_filename = f'45day_WITS面試通過_percentage_{target_index}.pkl'
