# Best model for target 15: XGBRegressor with R² score: 0.04769377721552681
import pandas as pd
import numpy as np
import pickle
...
# 選擇特徵針對目標變量
target_index = 15  # '45day_正式入職_percentage' 在 y 的第 16 列
...
# 保存最佳模型
model_filename = f'45day_正式入職_percentage_{target_index}.pkl'
