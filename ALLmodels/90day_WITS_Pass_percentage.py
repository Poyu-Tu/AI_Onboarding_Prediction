# Best model for target 0: RandomForestRegressor(max_depth=20, min_samples_leaf=4) with R² score: 0.03956169973128354
import pandas as pd
import numpy as np
import pickle
...
# 選擇特徵針對目標變量
target_index = 0  # '90day_WITS面試通過_percentage' 在 y 的第 1 列
...
# 保存最佳模型
model_filename = f'90day_WITS面試通過_percentage_{target_index}.pkl'
