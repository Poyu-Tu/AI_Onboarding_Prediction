# Best model for target 13: <catboost.core.CatBoostRegressor object at 0x0000020FCD9A7E60> with R² score: 0.048037630678612775
import pandas as pd
import numpy as np
import pickle
...
# 選擇特徵針對目標變量
target_index = 13  # '75day_正式入職_percentage' 在 y 的第 14 列
...
# 保存最佳模型
model_filename = f'75day_正式入職_percentage_{target_index}.pkl'
