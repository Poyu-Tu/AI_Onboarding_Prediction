# Best model for target 1: RandomForestRegressor(max_depth=10, min_samples_leaf=4) with R² score: 0.029611215503268395
import pandas as pd
import numpy as np
import pickle
...
# 選擇特徵針對目標變量
target_index = 1  # '75day_WITS面試通過_percentage' 在 y 的第 2 列
...
# 保存最佳模型
model_filename = f'75day_WITS面試通過_percentage_{target_index}.pkl'
