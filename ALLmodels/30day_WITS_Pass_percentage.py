# Best model for target 4: RandomForestRegressor(max_depth=20, min_samples_leaf=4, min_samples_split=10) with R² score: 0.10017911150892822
import pandas as pd
import numpy as np
import pickle
...
# 選擇特徵針對目標變量
target_index = 4  # '30day_WITS面試通過_percentage' 在 y 的第 5 列
...
# 保存最佳模型
model_filename = f'30day_WITS面試通過_percentage_{target_index}.pkl'
