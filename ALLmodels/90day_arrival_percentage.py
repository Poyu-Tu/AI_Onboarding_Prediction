# Best model for target 12: GradientBoostingRegressor(learning_rate=0.01, subsample=0.6) with R² score: 0.044636588046240044
import pandas as pd
import numpy as np
import pickle
...
# 選擇特徵針對目標變量
target_index = 12  # '90day_正式入職_percentage' 在 y 的第 13 列
...
# 保存最佳模型
model_filename = f'90day_正式入職_percentage_{target_index}.pkl'
