# Best model for target 2: RandomForestRegressor(max_depth=30, min_samples_leaf=4, min_samples_split=10,n_estimators=200) with R² score: 0.03878855373045986
import pandas as pd
import numpy as np
import pickle
...
# 選擇特徵針對目標變量
target_index = 2  # '60day_WITS面試通過_percentage' 在 y 的第 3 列
...
# 保存最佳模型
model_filename = f'60day_WITS面試通過_percentage_{target_index}.pkl'
