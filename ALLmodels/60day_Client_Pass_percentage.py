# Best model for target 8: <catboost.core.CatBoostRegressor object at 0x0000023F7F979A90> with R² score: 0.3414196103854402
import pandas as pd
import numpy as np
import pickle
...
# 選擇特徵針對目標變量
target_index = 8  # '60day_客戶面試通過_percentage' 在 y 的第 9 列
...
# 保存最佳模型
model_filename = f'60day_客戶面試通過_percentage_{target_index}.pkl'
