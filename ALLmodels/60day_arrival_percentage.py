# Best model for target 14: GradientBoostingRegressor(learning_rate=0.01, subsample=0.6) with R² score: 0.04356897629195855
import pandas as pd
import numpy as np
import pickle
...
# 選擇特徵針對目標變量
target_index = 14  # '60day_正式入職_percentage' 在 y 的第 15 列
...
# 保存最佳模型
model_filename = f'60day_正式入職_percentage_{target_index}.pkl'
